  ...
  return (
    <SafeAreaView style={styles.bgWrapper}>
      ...
      <View style={styles.buttonRow}>
        {/* No Button */}
        <TouchableOpacity style={[styles.roundButton, { backgroundColor: '#ff6b6b' }]} onPress={() => sendEmergencyMessage("No tapped")}>
      ...
      <TouchableOpacity style={{ backgroundColor: 'red', justifyContent: "center", alignSelf: "center", marginTop: 60, padding: 20, borderRadius: 10 }} onPress={() => props.navigation.push('AudioRecord')}>
        <Text style={{ color: "white", fontSize: 16, fontWeight: '600' }}>Record Audio</Text>
      </TouchableOpacity>
